...
func main() {
	clientOptions := options.Client().ApplyURI("mongodb+srv://martinezmendietagerman:gcUquzweT2VQIarm@cluster0.6b2lffl.mongodb.net/?retryWrites=true&w=majority") // Reemplaza con tu URL de MongoDB.
